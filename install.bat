...
llava_env\Scripts\python -m pip install git+https://github.com/helena-intel/Llava-Med.git@helena/openvino-support-aipc
...
copy llava-med-imf16-llmint4\*py .
echo huggingface-cli download helenai/llava-med-imf16-llmint8 --local-dir llava-med-imf16-llmint8 > update.bat
echo curl -O  >> update.bat
