...
llava_env\Scripts\hf download helenai/llava-med-imf16-llmint8 --local-dir llava-med-imf16-llmint8
...
echo llava_env\Scripts\hf download helenai/llava-med-imf16-llmint8 --local-dir llava-med-imf16-llmint8 > update.bat
